...
class JavaBeanBinder implements BeanBinder {
	...
	public <T> T bind(ConfigurationPropertyName name, Bindable<T> target, Context context,
		...
		boolean bound = bind(propertyBinder, bean, beanSupplier);//【主线】
	...
	private <T> boolean bind(BeanPropertyBinder propertyBinder, Bean<T> bean,
		...
		boolean bound = false;
		for (Map.Entry<String, BeanProperty> entry : bean.getProperties().entrySet()) { // bean是JavaBeanBinder$Bean类型,其属性type与@ConfigurationProperties注解的类相对应，比如type为ServerProperties
	...
	private <T> boolean bind(BeanSupplier<T> beanSupplier,
		...
		Object bound = propertyBinder.bindProperty(propertyName,// 【主线】
